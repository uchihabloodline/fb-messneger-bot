...
class Jarvis_shivam(Client):

    # Connect to dialogflow
    def apiaiCon(self):
        self.CLIENT_ACCESS_TOKEN = "612cb56789fe4cd6b296ffa54fb07cb3"
    ...
    def onMessage(self, author_id=None, message_object=None, thread_id=None, thread_type=ThreadType.USER, **kwargs):
        ...
        # Get the response which is a json objectPandey\AppData\Local\Programs\Python\Python35-32\lib\encodings\utf_8.py",
...
client = Jarvis_shivam('shivam.pandey.581730@facebook.com', 'hacker@18')
